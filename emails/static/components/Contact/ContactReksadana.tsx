...
const ContactReksadana = () => {
  return (
    <Section className="p-6">
      <Row>
        <Column>
          <Text className="text-base font-arial m-0 mb-4 font-bold text-[#5C6E7D]">
      ...
      <Row>
        <Column className="flex gap-4">
          <a
            ...
            className="bg-[#EFF1F3] flex items-center gap-2 px-4 py-2 no-underline rounded"
          >
            <Img
              src="https://images.bareksa.com/icons/email-stock-comment.png"
              className="w-5 h-5"
            />
            <Text className="text-sm font-arial m-0 font-normal text-[#000000]">
              Live Chat
            </Text>
          </a>
          <a
            href="tel:02180676767"
            className="bg-[#EFF1F3] flex items-center gap-2 px-4 py-2 no-underline rounded"
          >
            <Img
...
export default ContactReksadana;
