    ...
    <Layout>
      ...
      <Section className="p-6">
        ...
        <Row className="mb-4">
          <Column>
            <Text className="text-base font-arial m-0 font-normal text-[#3D4751]">
              Ini saatnya kamu kembali berinvestasi reksa dana yang dapat
              memberikan potensi keuntungan maksimal. Tim Analis Bareksa telah
              mengkurasi produk-produk reksa dana pilihan untukmu.
            </Text>
          </Column>
        </Row>
        <Row className="mb-4">
        ...
        <Row className="mb-4">
          <Column>
            <Text className="text-base font-arial m-0 font-normal text-[#3D4751]">
              Ayo mulai kembali investasi reksa dana kamu dan selesaikan
              transaksi sebelum pukul 13.00 WIB untuk mendapatkan harga/unit
              hari ini.
            </Text>
          </Column>
        </Row>
