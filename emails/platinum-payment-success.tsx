      ...
      <Tailwind>
        <Section width={600} style={{ fontFamily: 'Arial' }}>
          ...
          <Section className="px-6 bg-white">
            <div className="bg-[#E6F6EA] rounded-md py-6 px-3 mb-6">
              <p className="text-[#04913D] text-xl font-semibold leading-6 m-0">
                Pembayaraan Berhasil
              </p>
            </div>
          </Section>
          ...
          <Section className="px-6 bg-white pt-4">
            <Text className="text-[#3D4751] text-base font-normal leading-6 m-0">
              Selanjutnya, NAB dan total unit reksa dana akan diinformasikan
              melalui Surat Konfirmasi Transaksi yang akan dikirimkan oleh Bank
              Kustodian.
            </Text>
          </Section>
