    ...
    <Layout>
      ...
      <Section className="p-6">
        ...
        <Row className="mb-4">
          <Column>
            <div className="p-3 bg-[#EFF1F3]">
              ...
              <Text className="text-sm font-arial m-0 mb-3 font-bold text-[#2B323A]">
                Salinan fisik (hard copy) dokumen tidak dikirim sampai waktu
                yang ditentukan.
              </Text>
            </div>
          </Column>
        ...
        <Row className="mb-4">
          <Column>
            <Text className="text-base font-arial m-0 font-normal text-[#3D4751]">
              Tak perlu khawatir, setelah ini, kamu dapat melakukan pendaftaran
              kembali melalui aplikasi Bareksa. Kini, pendaftaran untuk semua
              jenis rekening akan diproses dalam 1 hari kerja bursa (bila
              dilakukan sebelum pukul 12.00 WIB).
            </Text>
          </Column>
        </Row>
        <Row className="mb-4">
