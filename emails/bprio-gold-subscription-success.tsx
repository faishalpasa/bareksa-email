...
const TABLE_ROWS = [
  ...
  {
    field: 'Total Biaya Pembelian',
    value: TABLE_CELL_VALUE
  }
];

const BprioGoldSubscriptionSuccess = () => {
  return (
    <LayoutBprio>
      <table
        bgcolor="#F5F5F5"
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        >
                                          ...
                                          >
                                            Pembelian emas Treasury Anda telah
...
export default BprioGoldSubscriptionSuccess;
